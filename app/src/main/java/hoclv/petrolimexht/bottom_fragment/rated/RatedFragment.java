...
import hoclv.petrolimexht.bottom_fragment.not_yet_rated.NotYetRatedAdapter;
 ...
 */
public class RatedFragment extends Fragment  implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void initView() {
        ...
        adapter = new RatedAdapter(getActivity());
